...
export function CollageProjectCard({
  project,
  size = "large",
}: CollageProjectCardProps) {
      ...
      >
        ...
        <div className="relative w-full h-full overflow-hidden">
          {displayVideo ? (
              ...
              <video
                ...
                onError={(e) => {
                  console.error(
                    ...
                    getMediaUrl(displayVideo)
                  );
                }}
              />
              <div className="absolute z-20 p-2 rounded-full top-4 left-4 bg-black/60 backdrop-blur-sm opacity-80">
            ...
            <img
              src={
                displayImage ? getMediaUrl(displayImage) : "/placeholder.svg"
              }
              alt={project.title}
              className={`w-full h-full object-cover transition-transform duration-700 ${
                isHovered ? "scale-110" : "scale-100"
          ...
          <div className="absolute inset-0 z-10 flex flex-col justify-end p-6">
            <div className="mb-2">
              <span className="px-3 py-1 text-xs font-semibold rounded-md md:text-sm text-primary bg-white/20 backdrop-blur-sm">
                {project.category}
              </span>
            </div>
            <h3
