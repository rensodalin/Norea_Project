  ...
  return (
    <Link href={`/projects/${project.id}`}>
      ...
      >
        ...
        {/* Project Info - Always visible with better contrast */}
        <div className="absolute bottom-0 left-0 right-0 p-6 pb-8 bg-gradient-to-t from-black/90 via-black/70 to-transparent min-h-[140px] flex items-end">
          <p
            className={`text-white text-sm md:text-base leading-relaxed transition-all duration-300 ${
