...
import { EnhancedProjectGallery } from "@/components/Enchanced/enhanced-project-gallery";
import { EnhancedCategorizedGallery } from "@/components/Enchanced/enhanced-categorized-gallery";
    ...
    <main className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="absolute top-6 left-6 z-30">
          <Link href="/#work">
            <Button
              variant="ghost"
              className="bg-background/80 backdrop-blur-sm text-foreground hover:bg-background/90 border border-border/50"
            >
                  ...
                  <ul className="space-y-2">
                    {project.details.solutions.map((solution, index) => (
                      <li
                        ...
                        className="text-muted-foreground flex items-start"
                      >
                        <span className="mr-2" style={{ color: "#9ACD32" }}>
                          •
                        </span>
                        {solution}
                      </li>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {project.details.software.map((software) => (
                  <span
                    key={software}
                    className="px-3 py-1 bg-secondary text-foreground text-sm"
                  >
                    {software}
                  </span>
                ))}
      ...
      {project.videos && project.videos.length > 0 && (
        <div className="container mx-auto px-6 mb-16">
          <h2 className="text-3xl font-bold text-foreground mb-12 text-center">
            Animation & Video Showcase
          </h2>
          <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
            Experience our architectural visualizations through cinematic
            animations and dynamic presentations
          </p>
      ...
      <div className="text-center py-16 border-t border-border">
        ...
        <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
          Let's bring your architectural vision to life with stunning
